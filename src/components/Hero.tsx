...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-white px-6 py-12 md:px-8 lg:px-12 lg:py-16">
      {/* 🍁 BACKGROUND MAPLE LEAF */}
      <div className="pointer-events-none absolute right-0 top-10 text-[180px] text-green-100 opacity-20 select-none">
        🍁
      </div>
      ...
      <div className="grid items-center gap-12 lg:grid-cols-2">
        <div className="max-w-[660px]">
          ...
          <motion.div
            ...
            className="mb-4 inline-flex items-center gap-2 rounded-full border border-red-200 px-4 py-2 text-sm text-red-500"
          >
            🍁 Proudly Canadian
          </motion.div>
          ...
          >
            Pest Control in Metro Vancouver & Fraser Valley —
          ...
          >
            🍁 Serving Metro Vancouver & Fraser Valley. Reliable pest control
            services for homes and businesses with safe, eco-friendly, and
            effective solutions.
          </motion.p>
